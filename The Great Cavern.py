...
try:
    ...
    save.readline() #    save.write("Global Variables"+"\n")
    save.readline() #    save.write("alive"+"\n")
    alive = int(save.readline()) #save.write(str(alive)+"\n")
    save.readline() #    save.write("PreviousLocation"+"\n")
    PreviousLocation = int(save.readline()) #    save.write(str(PreviousLocation)+"\n")
    save.readline() #    save.write("knightcounter"+"\n")
    knightcounter = int(save.readline()) #    save.write(str(knightcounter)+"\n")
    
    save.readline() #    save.write("CurrentLocation"+"\n")
    CurrentLocation = int(save.readline()) #    save.write(str(CurrentLocation)+"\n")
    save.readline() #    save.write("Locations Viewed"+"\n")
    checker = 0
    while checker <= len(Locations)-1:
        Locations[checker][7]= int(save.readline())
        checker += 1
    save.readline() #    save.write("Item Position"+"\n")
    checker2 = 0
...
def Help():
    ...
    print ("      You can save the game by using 'q'.")
...
def Look():
    ...
    if  Locations[CurrentLocation][7] == 10:
        print ("Be careful, don't strain your eyes.")
    if  Locations[CurrentLocation][7] == 25:
